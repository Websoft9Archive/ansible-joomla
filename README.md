...
```
joomla_download_url: "https://github.com/joomla/joomla-cms/releases/download/3.9.19/Joomla_3.9.19-Stable-Full_Package.zip"
```
...
```
wget -N https://raw.githubusercontent.com/Websoft9/ansible-linux/master/scripts/install.sh; bash install.sh -r joomla
```
